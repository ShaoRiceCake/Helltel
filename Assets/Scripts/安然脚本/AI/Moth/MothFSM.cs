...
{
    [Header("��ǰĿ�����")] public List<GameObject> targets = new List<GameObject>();
    [Header("�˺�")] public float damage = 15f;

    [Header("�����������ײ����")] public float distance;
    [Header("�Ƿ�Ϊ��ͷ��")] public bool IsLeader;
    [Header("���¶���")] public List<MothFSM> moths=new List<MothFSM>();
    ...
    public virtual MothFSM GetLeader()//������ͷ��
    {
        MothFSM leader = null;
    ...
    public virtual GameObject GetNearTarget()//����ھ�����ͷ�������
    {
...
public class MothChasing : IState
{
    ...
    public override void Update()
    {
        ...
        {
            manager.SetDestination(manager.GetLeader().transform);//������ͷ�������ͷ��
