...
public class AnimNode_moth_attaching: StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        AudioManager.Instance.Play("蛾子贴脸", animator.transform.position, loop: true,owner: owner);
    }
    ...
    {
        MonoBehaviour owner = animator.transform.gameObject.GetComponent<MonoBehaviour>();
        AudioManager.Instance.Stop("蛾子贴脸", owner);
    }
